...
<html>
    ...
    <body>
        ...
        <div id="show-language" class="content scaffold-show" role="main">
            ...
            <f:display bean="language" />
            <g:form resource="${this.language}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.language}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
