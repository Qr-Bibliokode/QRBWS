...
<html>
    ...
    <body>
        ...
        <div id="show-status" class="content scaffold-show" role="main">
            ...
            <f:display bean="status" />
            <g:form resource="${this.status}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.status}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
