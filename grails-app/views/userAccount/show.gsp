...
<body>
<a href="#show-userAccount" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="show-userAccount" class="content scaffold-show" role="main">
    ...
    <f:display bean="userAccount"/>
    <g:form resource="${this.userAccount}" method="DELETE">
        <fieldset class="buttons">
            <g:link class="edit" action="edit" resource="${this.userAccount}"><g:message
